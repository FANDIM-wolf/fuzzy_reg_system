...
class ExpertSystemBase:
    def __init__(self, data_path, x_columns, y_column,
        ...
        """
        Shared data module for the expert system
        """
        # Load data
        try:
            ...
            # Store rules
            self.fuzzy_rules = [rule for rule in fuzzy_rules if ' or ' not in rule]  # Remove rules with OR
    ...
    def visualize_fuzzy_sets(self):
        ...
        for var_name, sets in self.fuzzy_sets.items():
            ...
            # Add horizontal line at 0.5 to visualize overlap
...
class FuzzyModule:
    def __init__(self, expert_system):
        ...
        self.default_output = 5.0  # Default value if no rules fire
    ...
    def _create_fuzzy_system(self):
        ...
        # Create rules (only AND conditions)
        rules = []
...
if __name__ == "__main__":
    ...
    # Fuzzy variables configuration with corrected triangle calculation
    fuzzy_vars_config = {
    ...
    # Fuzzy rules (ONLY AND conditions)
    fuzzy_rules = [
    ...
    # Visualize fuzzy sets to verify correct overlap at 0.5
    ...
    # Make prediction
    example_input = {'T1': -20, 'T2': 0, 'H1': 10}
